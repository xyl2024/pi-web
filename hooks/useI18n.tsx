...
const ZH_TRANSLATIONS = {
  ...
  // LogsCenter (right-panel tab)
  "Logs": "日志",
  "Open logs": "打开日志",
  "Search messages, scopes, fields...": "搜索消息、scope、字段...",
  "Resume": "继续",
  "Pause incoming entries": "暂停接收新日志",
  "Logs cleared": "已清空日志",
  "Copy filtered entries to clipboard": "复制筛选后的日志到剪贴板",
  "Clear logs (server buffer is preserved)": "清空日志（server buffer 保留）",
  "Showing {n} / {cap}": "显示 {n} / {cap}",
  "Scope": "Scope",
  "All scopes": "全部 scope",
  "Session": "会话",
  "All sessions": "全部会话",
  "No options yet — wait for entries to arrive.": "暂无选项 — 等待日志进入。",
  "Paused — {n} entries dropped since you paused": "已暂停 — 期间丢弃 {n} 条",
  "Disconnected": "已断开",
  "No log entries match the current filters.": "当前筛选下没有日志条目。",
  ...
  "Inbox Test": "消息中心测试",
  "Push a synthetic message into the Inbox to preview the bell badge, list, and source chip. Real RSS / scheduler pushes are unchanged.": "向消息中心推送一条模拟消息，用于预览铃铛 badge、列表和来源 chip。真实的 RSS / 定时任务推送不受影响。",
  "Test source": "来源",
  "Test level": "级别",
  "Test title": "标题",
  "Test body": "正文",
