...
const ZH_TRANSLATIONS = {
  ...
  "Transactions": "流水笔数",
  "Budgets": "预算",
  "Budget overview": "本月预算总览",
  "No budgets set": "未设置预算",
  "Edit budgets": "管理预算",
  "Add budget": "添加预算",
  "No budgets yet — add one below": "还没有预算，点击下方添加",
  "Monthly limit": "每月限额",
  "Monthly limit must be a positive number for {category}": "{category} 的每月限额必须是正数",
  "Budget exceeded for {category}": "{category} 已超出预算",
  "Budget exceeded for {category} ({spent} of {limit})": "{category} 已超出预算（{spent} / {limit}）",
  "All months": "全部",
  "All categories": "全部分类",
