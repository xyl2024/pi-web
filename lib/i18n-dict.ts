...
export const ZH_TRANSLATIONS = {
  ...
  // Auto-naming feature (Session Naming section in SettingsModal + command palette toggle)
  "Session Naming": "会话命名",
  "Auto-name sessions": "自动命名会话",
  "Enable auto-naming": "启用自动命名",
  "Disable auto-naming": "关闭自动命名",
  "Auto-naming enabled": "自动命名已启用",
  "Auto-naming disabled": "自动命名已关闭",
  "Failed to update auto-naming": "更新自动命名设置失败",
  ...
  "Disconnected": "已断开",
  "No log entries match the current filters.": "当前筛选下没有日志。",
